...
def main():
    ...
    for sdr_input_path in tqdm(sdr_input_paths, desc="Processing SDR images"):
        ...
        with torch.no_grad():
            ...
            # prompt = [
            #         "a beautiful landscape with a clear sky and a mountain in the background",
            #         "a view of a lush green field with trees and hills in the distance",                    
            #         "a river running through a forest filled with rocks and trees",
            #         "An assortment of baskets with blue accents",
            #         "PJ Morton on 'Live Show Killer,' Praising His Church Roots and What We Can Expect from His New Album",
            #         "59 Chevy Apache | 1959 Chevrolet Apache Pickup. Processed ...",
            #         "purple classic cars | cars purple holden old cars holden efijy ...",
            #         "a view of a mountain with a few trees and a sky",
            #         "Detailed image of an artist's color palette",
            #         "Sunset over a lake and trees in the foreground",
            #         "Arafed cactus plant with a sunset in the background",  # Add comma here if more elements follow
            #     ]
            # prompt = ["Detailed image of an artist's color palette"]\
            prompt = [ "a beautiful landscape with a clear sky and a mountain in the background",]
            # 生成 Gain Map (GM)
            ...
            print(sdr_latent.shape, gm_latent.shape)
            ...
            print("sdr_image_decoded.shape", sdr_image_decoded.shape)
